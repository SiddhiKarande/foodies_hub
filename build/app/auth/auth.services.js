...
const auth_responses_1 = require("./auth.responses"); // Assuming you have predefined responses
...
const login = (loginData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Retrieve user by email and include the password
    const existingUser = yield user_services_1.default.getUserByEmail(email);
    ...
    // Generate JWT token
    const token = jsonwebtoken_1.default.sign({ userId: existingUser._id, email: existingUser.email }, process.env.JWT_SECRET, // Ensure JWT_SECRET is set in environment variables
    { expiresIn: '1h' });
